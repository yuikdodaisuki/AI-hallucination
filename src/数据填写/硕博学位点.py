...
#   {"学校名": "中山大学", "学术型博士学位点": 2, "专业型博士学位点": 3, "学术型硕士学位点": 0, "专业型硕士学位点": 2},
        indicators_data['学术型博士学位点'][school_name] = school['学术型博士学位点']
        indicators_data['专业型博士学位点'][school_name] = school['专业型博士学位点']
        indicators_data['学术型硕士学位点'][school_name] = school['学术型硕士学位点']
        indicators_data['专业型硕士学位点'][school_name] = school['专业型硕士学位点']
...
def process_single_indicator(base_dir, json_file, indicator_name, indicators_data):
    ...
    # 构建CSV文件路径
    csv_file_mapping = {
        '学术型博士学位点': 'ai_evaluation_dataset_long_学术型博士学位点_answers.csv',
        '专业型博士学位点': 'ai_evaluation_dataset_long_专业型博士学位点_answers.csv',
        '学术型硕士学位点': 'ai_evaluation_dataset_long_学术型硕士学位点_answers.csv',
        '专业型硕士学位点': 'ai_evaluation_dataset_long_专业型硕士学位点_answers.csv'
    }
...
def main():
    ...
    json_file = os.path.join(base_dir, "src/data/degree_programs/degree_program.json")
    ...
    try:
        ...
        total_schools = len(indicators_data['学术型博士学位点'])
