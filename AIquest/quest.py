...
def get_answers_from_llm_with_context(questions_list, document_text, model_name="qwen-turbo-1101"):
    ...
    messages = [
        ...
        {'role': 'assistant', 'content': "我已经记住了提供的文档内容，准备回答您的问题。"}
    ]
    ...
    try:
        ...
        for question_text in questions_list:
            ...
            current_messages.append({'role': 'user', 'content': f"请在之前提供的文本中找到问题 '{question_text}' 的答案。请只回答数字。如果找不到确切的数字答案，请回答 '未找到数字答案'。"})
